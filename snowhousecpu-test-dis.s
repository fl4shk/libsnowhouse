...
00000054 <_push_loop>:
  ...
  78:	04 00 00 90 	beq	r0, r0, 4

0000007c <_loop>:
  7c:	00 00 30 86 	ldr	r6, r3, 0
  80:	1c 00 d0 9d 	bl	lr, 28
  84:	04 00 31 86 	str	r6, r3, 4
  88:	04 00 30 03 	add	r3, r3, 4
  8c:	ff ff 10 01 	add	r1, r1, -1
  90:	14 00 d0 9d 	bl	lr, 20
  94:	e8 ff 01 91 	bne	r1, r0, -24

00000098 <_infin>:
  98:	00 00 00 90 	beq	r0, r0, 0
