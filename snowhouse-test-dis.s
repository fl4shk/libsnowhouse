...
00000050 <_push_loop>:
  ...
  74:	04 00 00 90 	beq	r0, r0, 4

00000078 <_loop>:
  78:	00 00 30 86 	ldr	r6, r3, 0
  7c:	1c 00 d0 9d 	bl	lr, 28
  80:	04 00 31 86 	str	r6, r3, 4
  84:	04 00 30 03 	add	r3, r3, 4
  88:	ff ff 10 01 	add	r1, r1, -1
  8c:	14 00 d0 9d 	bl	lr, 20
  90:	e8 ff 01 91 	bne	r1, r0, -24

00000094 <_infin>:
  94:	00 00 00 90 	beq	r0, r0, 0

00000098 <_increment>:
  98:	01 00 60 06 	add	r6, r6, 1
  9c:	00 00 d6 90 	jl	r0, lr

000000a0 <_divmod>:
  a0:	01 00 61 77 	udiv	r7, r6, r1
  a4:	03 00 61 78 	umod	r8, r6, r1
  a8:	00 00 d6 90 	jl	r0, lr

000000ac <_irq_handler>:
  ac:	01 00 a0 0a 	add	r10, r10, 1
  b0:	0a 00 00 60 	ret	ira
	...
