...
000000a0 <_loop>:
  ...
  b8:	00 00 00 a0 	bl	lr, 0 // pre #0x0
  bc:	00 00 d0 9d 
  c0:	00 00 00 a0 	bne	r1, r0, 0 // pre #0x0
  c4:	00 00 01 91 

000000c8 <_infin>:
  c8:	00 00 00 a0 	beq	r0, r0, 0 // pre #0x0
  cc:	00 00 00 90 

000000d0 <_increment>:
  d0:	01 00 60 06 	add	r6, r6, 1
  d4:	00 00 d6 90 	jl	r0, lr

000000d8 <_divmod>:
  d8:	01 00 61 77 	udiv	r7, r6, r1
  dc:	03 00 61 78 	umod	r8, r6, r1
  e0:	00 00 d6 90 	jl	r0, lr

000000e4 <_irq_handler>:
  e4:	01 00 a0 0a 	add	r10, r10, 1
  e8:	0a 00 00 60 	ret	ira
	...
