...
00000054 <_push_loop>:
  ...
  70:	78 56 00 0a 
  74:	78 56 00 a0 	add	r11, r0, 1450709556 // pre #0x5678
  78:	34 12 00 0b 
  7c:	00 00 61 77 	mul	r7, r6, r1
  80:	01 00 71 77 	udiv	r7, r7, r1
  84:	03 00 61 78 	umod	r8, r6, r1
  88:	04 00 00 90 	beq	r0, r0, 4

0000008c <_loop>:
  8c:	00 00 30 86 	ldr	r6, r3, 0
  90:	1c 00 d0 9d 	bl	lr, 28
  94:	04 00 31 86 	str	r6, r3, 4
  98:	04 00 30 03 	add	r3, r3, 4
  9c:	ff ff 10 01 	add	r1, r1, -1
  a0:	14 00 d0 9d 	bl	lr, 20
  a4:	e8 ff 01 91 	bne	r1, r0, -24

000000a8 <_infin>:
  a8:	00 00 00 90 	beq	r0, r0, 0

000000ac <_increment>:
  ac:	01 00 60 06 	add	r6, r6, 1
  b0:	00 00 d6 90 	jl	r0, lr

000000b4 <_divmod>:
  b4:	01 00 61 77 	udiv	r7, r6, r1
  b8:	03 00 61 78 	umod	r8, r6, r1
  bc:	00 00 d6 90 	jl	r0, lr

000000c0 <_irq_handler>:
  c0:	01 00 a0 0a 	add	r10, r10, 1
  c4:	0a 00 00 60 	ret	ira
	...
