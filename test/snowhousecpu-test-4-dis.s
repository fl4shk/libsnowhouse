...
00000054 <_push_loop>:
  ...
  70:	78 56 00 0a 
	...
  7c:	00 00 61 87 	mul	r7, r6, r1
  80:	01 00 71 87 	udiv	r7, r7, r1
  84:	03 00 61 88 	umod	r8, r6, r1
  88:	10 00 00 a0 	beq	r0, r0, 64
...
000000cc <_loop>:
  cc:	00 00 30 96 	ldr	r6, r3, 0
  d0:	16 00 00 bd 	bl	lr, 88
  d4:	04 00 31 96 	str	r6, r3, 4
  d8:	04 00 30 03 	add	r3, r3, 4
  dc:	ff ff 10 01 	add	r1, r1, -1
  e0:	24 00 00 bd 	bl	lr, 144
  e4:	f9 ff 01 a1 	bne	r1, r0, -28

000000e8 <_infin>:
  e8:	ff ff 00 a0 	beq	r0, r0, -4
...
00000174 <_divmod>:
 174:	01 00 61 87 	udiv	r7, r6, r1
 178:	03 00 61 88 	umod	r8, r6, r1
...
000001c0 <_irq_handler>:
 1c0:	01 00 a0 0a 	add	r10, r10, 1
 1c4:	0a 00 00 70 	ret	ira
	...
