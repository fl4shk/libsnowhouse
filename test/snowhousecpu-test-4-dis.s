...
000000cc <_loop>:
  cc:	00 00 30 86 	ldr	r6, r3, 0
  d0:	58 00 d0 9d 	bl	lr, 88
  d4:	04 00 31 86 	str	r6, r3, 4
  d8:	04 00 30 03 	add	r3, r3, 4
  dc:	ff ff 10 01 	add	r1, r1, -1
  e0:	90 00 d0 9d 	bl	lr, 144
  e4:	e4 ff 01 91 	bne	r1, r0, -28

000000e8 <_infin>:
  e8:	fc ff 00 90 	beq	r0, r0, -4
...
00000174 <_divmod>:
 174:	01 00 61 77 	udiv	r7, r6, r1
 178:	03 00 61 78 	umod	r8, r6, r1
 17c:	00 00 d6 90 	jl	r0, lr
