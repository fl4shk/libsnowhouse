...
00000240 <_udivw_test>:
 ...
 248:	0c 00 10 70 	cpy	hi, r1
 24c:	00 00 20 07 	add	r7, r2, 0
 250:	00 00 30 01 	add	r1, r3, 0
 254:	00 00 40 02 	add	r2, r4, 0
 258:	06 00 12 87 	udivw	r7, r1, r2
 25c:	0b 00 00 71 	cpy	r1, hi
 260:	00 00 70 02 	add	r2, r7, 0
...
00000270 <_sdivw_test>:
 ...
 278:	0c 00 10 70 	cpy	hi, r1
 27c:	00 00 20 07 	add	r7, r2, 0
 280:	00 00 30 01 	add	r1, r3, 0
 284:	00 00 40 02 	add	r2, r4, 0
 288:	07 00 12 87 	sdivw	r7, r1, r2
 28c:	0b 00 00 71 	cpy	r1, hi
 290:	00 00 70 02 	add	r2, r7, 0
...
000006e4 <.L1>:
 ...
 6e8:	04 00 f0 98 	ldr	r8, sp, 4
 6ec:	08 00 f0 99 	ldr	r9, sp, 8
 6f0:	0c 00 f0 9d 	ldr	lr, sp, 12
 6f4:	10 00 f0 0f 	add	sp, sp, 16
 6f8:	00 00 d6 a0 	jl	r0, lr
