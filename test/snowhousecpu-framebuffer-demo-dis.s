...
00000310 <_main>:
 ...
 324:	00 00 00 04 	add	r4, r0, 0
 328:	00 00 40 06 	add	r6, r4, 0
 32c:	40 01 00 05 	add	r5, r0, 320
 330:	01 00 00 c0 	add	r7, r0, 76800 // pre #0x1
 334:	00 2c 00 07 
...
00000340 <.L3>:
 340:	ff 00 10 62 	and	r2, r1, 255
 344:	00 00 24 02 	add	r2, r2, r4
 348:	00 00 31 92 	str	r2, r3, 0
 34c:	01 00 10 01 	add	r1, r1, 1
 350:	04 00 30 03 	add	r3, r3, 4
 354:	fa ff 51 a1 	bne	r1, r5, -24
 358:	00 05 d0 0d 	add	lr, lr, 1280
 35c:	40 01 60 06 	add	r6, r6, 320
 360:	00 01 40 04 	add	r4, r4, 256
 364:	f4 ff 71 a6 	bne	r6, r7, -48
