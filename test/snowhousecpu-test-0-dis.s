...
00000000 <_push_loop-0x68>:
  ...
  44:	00 00 30 95 	ldr	r5, r3, 0
  48:	00 00 00 00 	add	r0, r0, 0
  4c:	00 10 31 95 	str	r5, r3, 4096
  50:	00 00 00 00 	add	r0, r0, 0
  54:	00 10 30 96 	ldr	r6, r3, 4096
  58:	04 00 00 07 	add	r7, r0, 4
  5c:	00 10 30 98 	ldr	r8, r3, 4096
  60:	00 00 00 00 	add	r0, r0, 0
  64:	00 00 87 89 	mul	r9, r8, r7

00000068 <_push_loop>:
  68:	00 00 f1 97 	str	r7, sp, 0
  6c:	00 00 00 00 	add	r0, r0, 0
  70:	00 00 f0 98 	ldr	r8, sp, 0
  74:	00 00 00 00 	add	r0, r0, 0
  78:	01 00 80 09 	add	r9, r8, 1
  7c:	01 00 90 09 	add	r9, r9, 1
  80:	ff ff 70 07 	add	r7, r7, -1
  84:	f8 ff 01 a7 	bne	r7, r0, -32
  88:	00 00 61 87 	mul	r7, r6, r1
  8c:	01 00 71 87 	udiv	r7, r7, r1
  90:	03 00 61 88 	umod	r8, r6, r1
  94:	00 00 00 a0 	beq	r0, r0, 0

00000098 <_loop>:
  98:	00 00 30 96 	ldr	r6, r3, 0
  9c:	00 00 00 00 	add	r0, r0, 0
  a0:	07 00 00 bd 	bl	lr, 28
  a4:	04 00 31 96 	str	r6, r3, 4
  a8:	00 00 00 00 	add	r0, r0, 0
  ac:	04 00 30 03 	add	r3, r3, 4
  b0:	ff ff 10 01 	add	r1, r1, -1
  b4:	04 00 00 bd 	bl	lr, 16
  b8:	f7 ff 01 a1 	bne	r1, r0, -36
