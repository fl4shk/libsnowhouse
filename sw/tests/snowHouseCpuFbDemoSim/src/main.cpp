...
#include "VSnowHouseCpuFramebufferDemo.h"
...
protected:	// variables
	...
	//	this->top = top;
	//}
	//std::unique_ptr<VSnowHouseCpuFramebufferDemo> _top;
	//std::unique_ptr<VerilatedContext> _contextp;
	VSnowHouseCpuFramebufferDemo* _top = nullptr;
...
public:		// functions
	inline Vga(VSnowHouseCpuFramebufferDemo* s_top)
		: Display(),
		_top(s_top),
		//_top(new VSnowHouseCpuFramebufferDemo())
...
int main(int argc, char** argv) {
	...
	std::unique_ptr<VSnowHouseCpuFramebufferDemo> top(
		new VSnowHouseCpuFramebufferDemo()
	);
