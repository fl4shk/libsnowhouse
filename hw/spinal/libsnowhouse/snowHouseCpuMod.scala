...
object SnowHouseCpuOp {
  ...
  //def MultiCycleKindDivwhiRa = (0x7, 0x0)
...
object SnowHouseCpuOpInfoMap {
  ...
  //opInfoMap += (
  //  // divwhi rA
  //  SnowHouseCpuOp.DivwhiRa -> OpInfo.mkCpy(
  //  )
  //)
  //--------
  //opInfoMap += (
