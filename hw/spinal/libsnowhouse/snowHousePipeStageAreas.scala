...
case class SnowHousePipeStageInstrFetch(
  ...
  //  )
  //)
  val myH2dPushStm = cloneOf(io.lcvIbus.h2dBus)
  ...
  val myRegPcSetItCnt = cloneOf(upModExt.psIfRegPcSetItCnt)
  ...
  io.lcvIbus.h2dBus << myLcvIbusH2dFork.head 
