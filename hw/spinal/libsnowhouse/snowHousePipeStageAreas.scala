...
private[libsnowhouse] case class SnowHouseIbusToLcvIbusBridge(
  ...
  when (
    ...
    //when (rTempCnt.msb) {
      when (RegNext(io.ibus.nextValid, init=False)) {
        io.ibus.recvData.instr := myD2hPopStm.data
        io.ibus.ready := True
      }
    //}
    ...
    //when (
    //  ////myD2hPopStm.src === myH2dPushStm.src
    //  ////myD2hPopStm.src === io.ibus.sendData.srcLcvIbus - 1
    //  ////myD2hPopStm.src === io.ibus.sendData.srcLcvIbus - 2
    //  ////rTempCnt.msb
    //  //myD2hPopStm.src
    //  //=== RegNextWhen(
    //  //  next=myH2dPushStm.src,
    ...
    //  //rTempCnt := rTempCnt - 1
    //}
    //mySavedHaveOutstandingTxnClearCond := True
  }
  //when (io.ibus.fire) {
  //  rSavedHaveOutstandingTxn.payload := rSavedHaveOutstandingTxn.payload + 1
  //}
...
case class SnowHousePipeStageInstrFetch(
  ...
  //} else {
  //  //def tempH2dSrcRange = (
  //  //  io.lcvIbus.h2dBus.src.high downto 1
  //  //)
  //  //io.lcvIbus.h2dBus.src(tempH2dSrcRange) := (
  //  //  RegNextWhen(
  //  //    next=io.lcvIbus.h2dBus.src(tempH2dSrcRange),
  //  //    cond=(
  //  //      rLcvIbusState === MyLcvIbusState.IDLE
  //  //      && io.lcvIbus.h2dBus.fire
  //  //    ),
  //  //    init=io.lcvIbus.h2dBus.src(tempH2dSrcRange).getZero
  //  //  ) + 1
  //  //)
  //  //when (
  //  //  RegNext(
