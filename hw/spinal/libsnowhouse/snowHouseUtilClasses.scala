  ...
  val optForFmaxPsExFwdSize = (
    optForFmaxCfg match {
      case Some(myForFmaxCfg) => {
        myForFmaxCfg.numPostExPreWbPipeStages + 2//6//5//4//6//5//4//3//2//3//4//5//6//3//6//5//4//3//6//5//4//3//6//5//4//3//2//3//2//3//2//3//2//5//4//3//5
      }
      case None => {
        0
      }
    ...
    + (
      if (cfg.useLcvDataBus) (
        if (!cfg.optForFmax) (
          ...
          //2
          //1
          cfg.optForFmaxPsExFwdSize + 2//3//2//1//0//1//2//1 //+ 2//1//2//1//2//4//3//1
